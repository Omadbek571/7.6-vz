    ...
    <div className='bg-white'>
      <header className='bg-blue-950'>
        <div className='p-2 container max-w-[1440px] text-white flex justify-end gap-5 px-16'>
          <Link to="/register" className='hover:text-blue-300' onClick={handleLogout}>Create Account</Link>
          <Link to="/login" className='hover:text-blue-300' onClick={handleLogout}>Sign in / Guest</Link>
        </div>
      </header>
      ...
      <main className='container mx-auto mt-[80px]'>
        <Routes>
          ...
          <Route 
            ...
            element={
              <PrivateRoute isAuth={!!token}>
                <Card products={products} updateProductQuantity={updateProductQuantity} />
              </PrivateRoute>
            } 
          />
          <Route 
            ...
            element={
              <PrivateRoute isAuth={!!token}>
                <Detailes addProductToCard={addProductToCard} />
              </PrivateRoute>
            } 
          />
